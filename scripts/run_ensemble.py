...
with multiprocessing.Pool(N_PROCS) as pool:
    ...
    stream_ensemble(outfile, tqdm(batch, total=SAMPLES))
...
ds = xarray.load_dataset(outfile)
print(ds)
print("Mean temperature anomaly:")
print(ds.temperature.mean(("ensemble_member", "time")).data)
